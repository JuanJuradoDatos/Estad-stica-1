# -*- coding: utf-8 -*-
"""
Created on Sun Dec  4 18:55:16 2022
...
X = tmp_2.drop(['target_name'], axis = 1)

y = tmp_2['target_name']

#se realiza la particion de datos de entrenamiento y de test 
...
#se normalizan los datos usando las librerias adecuadas
...
#se crea la regrecion logistica desde lo mas basico 
